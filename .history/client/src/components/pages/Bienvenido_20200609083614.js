    ...
    <div className='flex flex-col justify-between h-full'>
      {leerMas ? (
        ...
        <Fragment>
          ...
          <button
            className='inline-block text-sm opacity-75 bg-transparent rounded bg-black hover:bg-gray-600 active:bg-blue-500 text-white px-3 py-2  focus:outline-none focus:font-bold mb-3'
            onClick={() => setLeerMas(!leerMas)}
          >
            Volver
          </button>
