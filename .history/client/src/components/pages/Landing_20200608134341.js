        ...
        <div className='w-1/2 p-3 text-center bg-gray-200'>
          ...
          <div className='m-2'>
            ...
            <p>
              ...
              mientras el COVID sigue en nuestras vidas. Los momentos más duros
              de esta pandemia pasarán pero la normalidad no llegará a nuestras
              vidas durante un buen tiempo.
            </p>
            <p>
              {' '}
              <span>
              ...
              Santiago a distriubirse en los distintos sectores actualmente
              publicados.
            </p>
          </div>
        </div>
