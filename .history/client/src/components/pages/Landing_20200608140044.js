      ...
      <div className='flex w-full h-full justify-center items-stretch'>
        <div className='w-1/2 p-3 text-center bg-gray-200'>
          ...
          <div className='flex w-full justify-center items-center'>
            <div className='w-full border-2 border-red-500 rounded'>
              <h3 className='text-center text-red-600'>
                <i class='fas fa-skull-crossbones'></i> ¡Importante!
              </h3>
              <p>
                {' '}
                Esta página te pide que respetes todas las medidas oficiales y
                por ningún motivo es un medio oficial.
              </p>
            </div>
          </div>
        </div>
