      ...
      <div className='flex w-full h-full justify-center items-stretch'>
        <div className='w-1/2 p-3 text-center bg-gray-200 flex flex-col justify-center'>
          ...
          <p className='mb-2 text-left'>
            Sabemos que nadie esta yendo a escalar, pero si para todos esos
            escaladores invisibles está Ghost Climberapp.all('*',
            requireAuthentication, loadUser);Ingresa y registra tu visita para
            poder dividrnos mejor en los sectores de escalada.{' '}
            <i class='fas fa-smile-wink'></i>
          </p>
          <input
            className='block self-start bg-transparent focus:outline-none focus:font-bold mb-5'
            type='submit'
            value='Leer más...'
