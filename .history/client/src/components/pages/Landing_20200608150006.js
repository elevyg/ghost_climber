...
const Landing = () => {
  ...
  return (
    <Fragment>
      <div className='flex w-full h-full justify-center items-stretch overflow-auto'>
        <div className='w-1/2 h-full p-3 text-center bg-gray-200 flex flex-col justify-between'>
          <div className='flex flex-col justify-center'>
            <h3 className='text-left text-3xl mb-4 mt-40'> Bienvenido,</h3>
            ...
            {leerMas && (
              <div className='landing m-2'>
                <p className='mb-3 text-left'>
                  Esta página fue diseñada para mantener el distanciamiento
                  social en zonas de escalada mientras el COVID sigue en
                  nuestras vidas. Los momentos más duros de esta pandemia
                  pasarán pero la normalidad no llegará a nuestras vidas durante
                  un buen tiempo.
                </p>
                <p className='mb-3 text-left'>
                  <span>
