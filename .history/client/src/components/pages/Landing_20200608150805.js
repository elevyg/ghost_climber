...
const Landing = () => {
  ...
  return (
    <Fragment>
      <div className='flex flex-col md:flex-row w-full h-screen md:h-full justify-center items-stretch'>
        <div className='flex flex-col w-1/2 h-full p-3 text-center bg-gray-200  justify-between'>
          <Bienvenido />
        </div>
        {/* Segunda mitad */}
