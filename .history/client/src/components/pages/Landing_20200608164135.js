...
const Landing = () => {
  ...
  return (
    <Fragment>
      <div className='flex flex-col md:flex-row w-full h-full md:justify-center md:items-stretch'>
        <div className='hidden md:flex flex-col w-1/2 h-full p-3 text-center bg-gray-200  justify-between'>
          <Bienvenido />
        </div>
        {/* Segunda mitad */}
        <div className='md:w-1/2 h-screen md:h-full flex flex-col md:justify-center md:items-center'>
