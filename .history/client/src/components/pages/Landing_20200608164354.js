...
const Landing = () => {
  ...
  return (
    <Fragment>
      <div className='flex flex-col md:flex-row w-full h-screen md:h-full md:justify-center md:items-stretch'>
        ...
        <div className='md:hidden h-screen p-3 text-center bg-gray-200  justify-between'>
          <Bienvenido />
        </div>
      </div>
    </Fragment>
