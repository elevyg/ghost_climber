    ...
    <Fragment>
      <div className='flex flex-col md:flex-row w-full md:h-full md:justify-center md:items-stretch'>
        ...
        <div className='md:w-1/2 h-screen md:h-full flex flex-col justify-center items-center'>
          ...
          <div className='md:hidden flex flex-col justify-center items-center text-xl text-gray-500'>
            <p>Más Info </p>{' '}
            <i className='block fas fa-arrow-alt-circle-down'></i>
          </div>
        </div>
        <div className='md:hidden h-screen p-3 text-center bg-gray-200  justify-around'>
          <Bienvenido />
        </div>
      </div>
    </Fragment>
