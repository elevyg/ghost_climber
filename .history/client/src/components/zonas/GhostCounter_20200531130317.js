...
const GhostCounter = () => {
  ...
  return (
    <div id='' className='relative flex pr-3 items-center justify-center'>
      <button
        className={
          ' absolute inset-x-0 top-0 inline-block flex justify-center items-center rounded  px-3 ' +
          (counter === 0
      ...
      {counter > 0 ? (
        <button
          className='absolute inset-y-0.right-0 inline-block flex justify-center items-center text-sm ml-2 text-gray-500'
          onClick={resetCount}
        >
