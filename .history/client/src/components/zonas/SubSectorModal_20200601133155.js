...
const SubSectorModal = ({ setShowModal, subsectores, sector }) => {
  ...
  return (
    <Fragment>
      <div className='justify-center items-center flex  overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none sm:w-screen'>
        <div className='relative w-auto my-6 mx-auto max-w-3xl'>
          ...
          <div className='border-0  relative flex flex-col w-full h-full bg-white outline-none focus:outline-none rounded-b'>
