  ...
  return (
    <Fragment>
      <div className='justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none'>
        <div className='relative max-w-2xl max-h-screen sm:w-screen my-4 mx-auto '>
          {/*content*/}
          ...
          <div className='border-0 flex flex-col w-full h-full bg-white outline-none focus:outline-none rounded-b'>
            <div className='grid grid-cols-1 md:grid-cols-3   grid-row-col gap-4 p-3 overflow-x-hidden'>
              {subsectores &&
