...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  if (!user) {
    return next(
      new ErrorResponse(`There is no user with ${req.body.email}`),
      404
    );
  }
  ...
  const message = `You are receiving this email because you (or someone else) has requested thee reset of a password. Please make a PUT request to: \n\n ${resetUrl}`;
