  ...
  return (
    <div className='container flex flex-col bg-gray-500 rounded  shadow-md  m-3 w-1/3 p-3'>
      ...
      <form>
        ...
        <select className='form-select block w-full mt-1' id='grid-state'>
        ...
        <div className='flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1'>
          <a
            onClick={increment}
            className=' bg-gray-300 text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-20 rounded-l cursor-pointer outline-none pl-3'
          >
