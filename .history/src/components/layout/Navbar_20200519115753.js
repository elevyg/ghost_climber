...
const Navbar = () => {
  ...
  return (
    <nav className='flex items-center bg-gray-100 p-3 flex-wrap border-b border-b-2 border-gray-200'>
      ...
      <div className=' block lg:hidden'>
        <button
          className='text-gray inline-flex p-3 hover:bg-gray-300 rounded lg:hidden  hover:text-gray outline-none nav-toggler'
