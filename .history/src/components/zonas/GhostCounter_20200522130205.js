...
const GhostCounter = () => {
  return (
    <div className=' box-border flex items-stretch justify-end items-baseline content-center pr-3 w-1/3'>
      <div className='relative bg-blue-100 border-b rounded p-1 m-1 object-contain hover:bg-blue-200 checked:bg-blue-700'>
        <input
          type='checkbox'
          className=' absolute top-0 left-0 z-2 cursor-pointer w-full h-full opacity-0  '
        />
