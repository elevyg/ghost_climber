  ...
  return (
    <div id='wrapper' className='wrapper relative top-0 left-0 z-1 w-10 h-6'>
      <input
        type='checkbox'
        id='ghostToggler'
        className='ghostToggler absolute top-0 left-0 z-20 w-full h-full cursor-pointer opacity-0'
      />
      <div
        id='ghostBtn'
      ...
      >
        <div className='flex w-full h-full justify-center items-center text-gray-500 bg-blue-400 rounded px-4 z-1'>
          <h5>1</h5>
          <i className='fas z-1 fa-ghost text-white ml-1'></i>
        </div>
      </div>
    </div>
  );
