        ...
        {subsector &&
          subsector.map((sb) => (
            <div className='box-border flex items-center justify-left border-b hover:bg-gray-200'>
              ...
              <div className='box-border w-120 items-stretch justify-end flex'>
                <div className='bg-blue-100 border-b rounded p-1 m-1 items-baseline content-center justify-around min-w-15  object-contain'>
