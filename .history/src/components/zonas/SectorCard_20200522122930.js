        ...
        {subsector &&
          subsector.map((sb) => (
            <div className='box-border flex items-center justify-left border-b hover:bg-gray-200'>
              <div className='block w-240 group hover:bg-blue p-2 w-full'>
              ...
              <div className='box-border min-w-120 items-stretch justify-end flex items-baseline content-center justify-around  w-full'>
                <div className='bg-blue-100 border-b rounded p-1 m-1  min-w-15  object-contain'>
